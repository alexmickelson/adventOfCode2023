...
public class Tests
{
    ...
    {
        Poker.CompareHand("AKQJJ", "KKQJJ").Should().BeLessThan(0);
    }
    
    [Test]
    public void twoPair_beats_onePair2()
    {
        Poker.CompareHand("KKQJJ", "AKQJJ").Should().BeGreaterThan(0);
    }
    
    [Test]
    public void fullhouse_beats_twopair()
    {
        Poker.CompareHand("222JJ", "AAQJJ").Should().BeGreaterThan(0);
    }
    [Test]
    public void fullhouse_beats_twopair2()
    {
        Poker.CompareHand("AAQJJ", "222JJ").Should().BeLessThan(0);
    }
    ...
    {
        Poker.CompareHand("KK677", "KTJJT").Should().BeGreaterThan(0);
    }
    [Test]
    public void twopair_sameRank_comparevalue2()
    {
        Poker.CompareHand("KTJJT", "KK677").Should().BeLessThan(0);
    }
    [Test]
    ...
    {
        Poker.CompareHand("AKQJ9", "23456").Should().BeGreaterThan(0);
    }
